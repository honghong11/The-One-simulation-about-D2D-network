...
public class Settings {
	...
	//public static final String DEF_SETTINGS_FILE ="wdm_settings/OfficeSize10.txt";
	public static final String DEF_SETTINGS_FILE ="cluster_settings.txt";
	...
	public static void init(String propFile) throws SettingsError {
		...
		try {
			if (new File(DEF_SETTINGS_FILE).exists()) {
				...
				//props为读入的默认setting文件,Properties 用来处理配置文件，从输入流中读入键值对
